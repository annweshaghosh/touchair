...
using BoilerPlate_Project.Web.Controllers.Results;
using BoilerPlate_Project.Web.Models.Account;
...
{
    public class AccountController : BoilerPlate_ProjectControllerBase
    {
